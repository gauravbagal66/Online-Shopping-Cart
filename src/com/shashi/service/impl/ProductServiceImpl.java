...
public class ProductServiceImpl implements ProductService {
	...
	public String addProduct(String prodName, String prodType, String prodInfo, double prodPrice, int prodQuantity,
			InputStream prodImage, String shopAddress) {
	String status = null;
	String prodId = IDUtil.generateId();

	ProductBean product = new ProductBean(prodId, prodName, prodType, prodInfo, prodPrice, prodQuantity, prodImage, shopAddress);
	product.setShopAddress(shopAddress); // ✅ Set the shop address
	...
	public String addProduct(ProductBean product) {
		...
		try {
			...
			ps.setString(8, product.getShopAddress());
	...
	public String updateProduct(ProductBean prevProduct, ProductBean updatedProduct) {
		...
		try {
			ps = con.prepareStatement(
					"update product set pname=?,ptype=?,pinfo=?,pprice=?,pquantity=?,image=? where pid=?,shop_address=?");
			...
			ps.setString(8, updatedProduct.getShopAddress());
	...
	public List<ProductBean> getAllProducts() {
		...
		try {
			...
			while (rs.next()) {
				...
				product.setShopAddress(rs.getString(8));
	...
	public String updateProductWithoutImage(String prevProductId, ProductBean updatedProduct) {
		...
		try {
			ps = con.prepareStatement("update product set pname=?,ptype=?,pinfo=?,pprice=?,pquantity=? where pid=?,shop_address=?");
			...
			ps.setString(7, updatedProduct.getShopAddress());
